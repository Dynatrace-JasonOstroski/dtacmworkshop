...
deployGKE()
{
    ...
    gcloud container clusters create ostroskiacm --zone=us-central1-a --num-nodes=3 --machine-type=n1-highmem-2 --image-type=Ubuntu
...
deployAKS()
{
    ...
    export AKS_CLUSTER_NAME=ostroskiacm
